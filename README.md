...
<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>Cs2Int</code> &nbsp;·&nbsp; <code>cs2int</code>
</p>
...
CS2 internal skeleton — injected module layout, chams hook points, backtrack tab.

Paired search term with cs2-external; same game, different thread tags.
...
```bash
dotnet restore cs2-internal.slnx
dotnet build cs2-internal.slnx -c Release
dotnet test cs2-internal.slnx -c Release
```
